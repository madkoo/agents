...
tools: ['vscode', 'execute', 'read', 'agent', 'upstash/context7/*', 'github/*', 'edit', 'search', 'web', 'vscode/memory', 'todo']
---
...
### New Code
Focus on full behavioral coverage. Treat the specification as the source of truth. Test what the code *should* do, not just what it currently does.

...
agents: ["Planner", "Coder", "Tester", "Designer"]
---
...
- **Planner** —> GPT-5.5 - Creates implementation strategies and technical plans. Research the codebase, check docs, identify edge cases, and produce a detailed plan with file assignments.
- **Coder** —> GPT-5.4 - Implements the plan,  Writes code, fixes bugs. Always verify APIs with context7 tool.
- **Tester** —> GPT-5.4 - Writes and runs tests, verifies functionality
- **Designer** —> Claude Opus 4.6 - Own and Create  all UI/UX and styling decisions. Always use the frontend design skill. 
...
### Step 1: Get the Plan
Call the Planner agent with the user's request. The Planner will call the Tester to include testing plan. The Planner will return implementation steps.
